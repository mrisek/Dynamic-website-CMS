...
$sql="INSERT INTO Klijent (idKlijent, imeKlijent, prezimeKlijent, drzavaKlijent, emailKlijent, sobaKlijent, prehranaKlijent, datumKlijent)
VALUES ('$idKlijent', '$imeKlijent', '$prezimeKlijent', '$drzavaKlijent', '$emailKlijent', '$sobaKlijent', '$prehranaKlijent', '$datumKlijent')";

if (!mysqli_query($con,$sql)) {
  die('Error: ' . mysqli_error($con));
}

echo "Dodali ste 1 novi zapis u relaciju Klijent!";
