...
mysqli_query($con,"UPDATE Klijent SET imeKlijent='$imeKlijent', prezimeKlijent = '$prezimeKlijent', drzavaKlijent = '$drzavaKlijent', emailKlijent='$emailKlijent', sobaKlijent = '$sobaKlijent', prehranaKlijent = '$prehranaKlijent', datumKlijent='$datumKlijent'
WHERE idKlijent='$idKlijent'");

echo "Izmjenili ste 1 zapis u relaciji Rezervacija!\n";
