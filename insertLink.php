...
$nazivLink = mysqli_real_escape_string($con, $_POST['nazivLink']);
$sadrzajLink = mysqli_real_escape_string($con, $_POST['sadrzajLink']);


mysql_query("SET NAMES 'utf8'");
mysql_query("SET CHARACTER_SET 'utf8_unicode_ci'");

$sql="INSERT INTO Link (idLink, nazivLink, sadrzajLink)
VALUES ('$idLink', '$nazivLink', '$sadrzajLink')";

if (!mysqli_query($con,$sql)) {
  die('Error: ' . mysqli_error($con));
}
echo "Dodali ste 1 novi zapis u relaciju Link!";
