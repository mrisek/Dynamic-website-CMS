...
mysqli_query($con,"UPDATE Kontakt SET imeKontakt = '$imeKontakt', prezimeKontakt = '$prezimeKontakt', emailKontakt='$emailKontakt', porukaKontakt = '$porukaKontakt'
WHERE idKontakt='$idKontakt'");

echo "Izmjenili ste 1 zapis u relaciji Kontakt!\n";
