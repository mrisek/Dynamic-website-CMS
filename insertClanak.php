...
$slikaClanak = '<span class="left"><img src="upload/'.$slikaClanakNaziv.'" alt="example graphic" /></span>';
...
echo "Dodali ste 1 novi zapis u relaciju Clanak!";



echo "Naziv slike:".$slikaClanak;
