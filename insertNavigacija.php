...
$sql="INSERT INTO Navigacija (idNavigacija, nazivNavigacija, linkNavigacija, opisNavigacija)
VALUES ('$idNavigacija', '$nazivNavigacija', '$linkNavigacija', '$opisNavigacija')";

if (!mysqli_query($con,$sql)) {
  die('Error: ' . mysqli_error($con));
}

echo "Dodali ste 1 novi zapis u relaciju Navigacija!";
