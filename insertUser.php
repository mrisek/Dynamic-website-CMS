...
$imeUser = mysqli_real_escape_string($con, $_POST['imeUser']);
$lozinkaUser = mysqli_real_escape_string($con, $_POST['lozinkaUser']);


mysql_query("SET NAMES 'utf8'");
mysql_query("SET CHARACTER_SET 'utf8_unicode_ci'");

$sql="INSERT INTO User (idUser, imeUser, lozinkaUser)
VALUES ('$idUser', '$imeUser', '$lozinkaUser')";

if (!mysqli_query($con,$sql)) {
  die('Error: ' . mysqli_error($con));
}
echo "Dodali ste 1 novi zapis u relaciju User!";
