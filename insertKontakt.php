...
$sql="INSERT INTO Kontakt (idKontakt, imeKontakt, prezimeKontakt, emailKontakt, porukaKontakt)
VALUES ('$idKontakt', '$imeKontakt', '$prezimeKontakt', '$emailKontakt', '$porukaKontakt')";

if (!mysqli_query($con,$sql)) {
  die('Error: ' . mysqli_error($con));
}
echo "Dodali ste 1 novi zapis u relaciju Kontakt!";
