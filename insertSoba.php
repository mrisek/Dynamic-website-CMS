...
$nazivSoba = mysqli_real_escape_string($con, $_POST['nazivSoba']);
$uslugaSoba = mysqli_real_escape_string($con, $_POST['uslugaSoba']);
$cijenaSoba = mysqli_real_escape_string($con, $_POST['cijenaSoba']);
...
$sql="INSERT INTO Soba (idSoba, nazivSoba, uslugaSoba, cijenaSoba)
VALUES ('$idSoba', '$nazivSoba', '$uslugaSoba', '$cijenaSoba')";

if (!mysqli_query($con,$sql)) {
  die('Error: ' . mysqli_error($con));
}

echo "Dodali ste 1 novi zapis u relaciju Soba!";
