...
$nazivNavigacija = mysqli_real_escape_string($con, $_POST['nazivNavigacija']);
$linkNavigacija = mysqli_real_escape_string($con, $_POST['linkNavigacija']);
$opisNavigacija = mysqli_real_escape_string($con, $_POST['opisNavigacija']);

mysql_query("SET NAMES 'utf8'");
mysql_query("SET CHARACTER_SET 'utf8_unicode_ci'");

mysqli_query($con,"UPDATE Navigacija SET nazivNavigacija='$nazivNavigacija', linkNavigacija = '$linkNavigacija', opisNavigacija = '$opisNavigacija'
WHERE idNavigacija='$idNavigacija'");

echo "Izmjenili ste 1 zapis u relaciji Navigacija!\n";
