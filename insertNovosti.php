...
$naslovNovosti = mysqli_real_escape_string($con, $_POST['naslovNovosti']);
$sadrzajNovosti = mysqli_real_escape_string($con, $_POST['sadrzajNovosti']);
$datumNovosti = mysqli_real_escape_string($con, $_POST['datumNovosti']);
$linkNovosti = mysqli_real_escape_string($con, $_POST['linkNovosti']);
...
$sql="INSERT INTO Novosti (idNovosti, naslovNovosti, sadrzajNovosti, datumNovosti, linkNovosti)
VALUES ('$idNovosti', '$naslovNovosti', '$sadrzajNovosti', '$datumNovosti', '$linkNovosti')";

if (!mysqli_query($con,$sql)) {
  die('Error: ' . mysqli_error($con));
}
echo "Dodali ste 1 novi zapis u relaciju Novosti!";
