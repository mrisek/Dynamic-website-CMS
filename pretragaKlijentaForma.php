...
<form action="pretragaKlijenta.php" method="post">
<div class="form_settings">

<h2>Pretraga klijenta po prezimenu</h2>

<p>Unesite prezime:</p> <input type="text" name="prezimeKlijent"><br>
...
<br>
<a href="adminRezervacija.php">Povratak na prethodnu stranicu</a>
