...
{
    var a = document.forms["kontaktForma"]["imeKontakt"].value
    var b = document.forms["kontaktForma"]["porukaKontakt"].value
    ...
    //e-mail
    var x = document.forms["kontaktForma"]["emailKontakt"].value;
    ...
    if (atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length) {
		...
		var c = document.forms["kontaktForma"]["prezimeKontakt"].value
...
function validateForm() {
    ...
    //Validacija - Ime
	var x = document.forms["myForm"]["imeKlijent"].value;
    ...
    //Validacija - prezime
	var y = document.forms["myForm"]["prezimeKlijent"].value;
    ...
    //Validacija - država
	var z = document.forms["myForm"]["drzavaKlijent"].value;
	
    if (z == null || z == "") {
        alert("Morate upisati odakle dolazite!");
        return false;
    }
	    ...
	    //Validacija - E-mail
    var m = document.forms["myForm"]["emailKlijent"].value;
    ...
    //Validacija - Izbornik
    var a = document.forms["myForm"]["sobaKlijent"].value;
	...
	//Validacija - Datum
	var d = document.forms["myForm"]["datumKlijent"].value;
	
	    if (d == null || d == "") {
        alert("Datumi dolaska i odjave moraju biti upisani!");
        return false;
    }
    ...
    if ((radio1 == "") && (radio2 == "")) {
        alert("Potrebno je odabrati razinu prehrane!")
        return false;
    }
