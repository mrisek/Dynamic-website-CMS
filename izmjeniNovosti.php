...
mysqli_query($con,"UPDATE Novosti SET naslovNovosti='$naslovNovosti', sadrzajNovosti = '$sadrzajNovosti', datumNovosti = '$datumNovosti', linkNovosti = '$linkNovosti'
WHERE idNovosti='$idNovosti'");

echo "Izmjenili ste 1 zapis u relaciji Novosti!\n";
