...
$slikaGalerija = mysqli_real_escape_string($con, $_POST['slikaGalerija']);


mysql_query("SET NAMES 'utf8'");
mysql_query("SET CHARACTER_SET 'utf8_unicode_ci'");

mysqli_query($con,"UPDATE Galerija SET nazivGalerija = '$nazivGalerija',  slikaGalerija = '$slikaGalerija'
WHERE idGalerija='$idGalerija'");

echo "Izmjenili ste 1 zapis u relaciji Galerija!\n";
